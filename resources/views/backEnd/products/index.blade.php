...
@section('content')
    <div id="breadcrumb"> <a href="{{url('/admin')}}" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Accueil</a> <a href="{{route('product.index')}}" class="current">Produits</a></div>
                ...
                <table class="table table-bordered data-table">
                    ...
                    @foreach($products as $product)
                        ...
                        <tr class="gradeC">
                            ...
                            <td style="vertical-align: middle;text-align: center;"><a href="{{route('image-gallery.show',$product->id)}}" class="btn btn-default btn-mini">Images</a></td>
                            <td style="vertical-align: middle;text-align: center;"><a href="{{route('product_attr.show',$product->id)}}" class="btn btn-success btn-mini">Attributs</a></td>
                            <td style="text-align: center; vertical-align: middle;">
                                ...
                                <a href="javascript:" rel="{{$product->id}}" onclick="suppr({{$product->id}})" rel1="delete-product" class="btn btn-danger btn-mini deleteRecord">Supprimer</a>
                            </td>
                        </tr>
