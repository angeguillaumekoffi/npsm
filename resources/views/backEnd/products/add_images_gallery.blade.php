...
@section('content')
    <div id="breadcrumb"> <a href="{{url('/admin')}}" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Accueil</a> <a href="{{route('product.index')}}">Produits</a> <a href="#" class="current">Ajouter des Images</a> </div>
                        ...
                        <ul class="recent-posts">
                            ...
                            <li>
                                <form action="{{route('image-gallery.store')}}" method="post" role="form" enctype="multipart/form-data">
                                    <legend>Ajouter plusieures Images</legend>
                            ...
                            <?php $i=1; ?>
                                @foreach($imageGalleries as $imageGallery)
                                    <tr>
                                        ...
                                        <td style="text-align: center;vertical-align: middle;"><a href="javascript:" onclick="suppr({{$imageGallery->id}})" rel="{{$imageGallery->id}}" rel1="delete-imageGallery" class="btn btn-danger btn-mini deleteRecord">Delete</a></td>
                                    </tr>
                                @endforeach
                            </tbody>
                        </table>
...
@section('jsblock')
    ...
    <script>
        function suppr(id) {
            window.location.href="/admin/delete-imageGallery/"+id;
        }
    </script>
@endsection
