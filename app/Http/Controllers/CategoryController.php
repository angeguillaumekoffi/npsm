...
class CategoryController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('category.index')->with('message','Ajout réussi!');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('category.index')->with('message','Modifié!');
    }
    ...
    public function destroy($id)
    {
        ...
        $delete->delete();
        return redirect()->route('category.index')->with('message','Supprimé!');
    }
}
